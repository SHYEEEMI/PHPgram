        ...
        <div id="globalConst">
            <div class="d-flex flex-row align-items-center">
                <div class="d-inline-flex flex-grow-1 flex-shrink-0">
                    <a href="/feed/index"><img class="w130" src="/static/img/instagram_logo.svg"></a>
                </div>
                        ...
                        <div class="d-inline-flex dropdown">
                            <a href="#" role="button" id="navDropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" class="header_profile">
                                <div class="circleimg h30 w30">
                                    <!-- <img src="/static/img/profile/<?=$_SESSION[_LOGINUSER]->iuser?>/<?=$_SESSION[_LOGINUSER]->mainimg?>" onerror="this.onerror=null;this.src='/static/img/profile/profile.svg'"> -->
                                    <img class="profileimg" src="/static/img/profile/<?=getMainImgSrc()?>" onerror="this.onerror=null;this.src='/static/img/profile/bear.png'">
                                </div>
                            </a>
