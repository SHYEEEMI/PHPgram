        ...
        <div class="d-flex flex-row">            
                <div class="d-flex flex-column justify-content-center me-3">
                    <div class="circleimg h150 w150 pointer feedwin">
                        <img class="profileimg" data-bs-toggle="modal" data-bs-target="#changeProfileImgModal" src='/static/img/profile/<?=$this->data->iuser?>/<?=$this->data->mainimg?>' onerror='this.error=null;this.src="/static/img/profile/bear.png"'>  
                    </div>
                </div>
                <div class="flex-grow-1 d-flex flex-column justify-conent-evenly">
                    <div><?=$this->data->email?>
                        <?php
                        /*
                           ...
                           <?php } elseif($youme === 0 && $meyou === 0) {?>
                            ...
                            <?php } elseif(($youme === 1 && $meyou === 1) || ($youme === 0 && $meyou === 1)) {?>
